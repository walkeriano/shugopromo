...
import { isushicreadorTask } from "../firebase.js";
      ...
      <div className="flex">
        {!view && (
          <div className="screen-porcion-one">
            ...
            <div className="item-porcion">
              ...
              <div className="flex-box">
                <p className="tamano-porcion">PA´ COMPARTIR</p>
                <p className="p-recomendacion-combo">
                  20 cortes de makis + 2 Gaseosas de 500ml + Palitos + Salsas.
                </p>
                <Link
                  to="/makistore-isushi-creador-promo"
        ...
        {view ? (
          <div>
            ...
            {datos ? (
              <div className="screen-porcion-datos">
                <div className="titulo-creador">
                  <img src={isushilogo} className="image-brand" alt="logo" />
                  <div className="info-creador">
                    <div className="content-info">
...
export default IsushiCreadorForm;
